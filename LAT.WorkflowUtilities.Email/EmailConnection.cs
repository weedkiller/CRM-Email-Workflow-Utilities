...
namespace LAT.WorkflowUtilities.Email
{
    public class EmailConnection : WorkFlowActivityBase
    {
        ...
        protected override void ExecuteCrmWorkFlowActivity(CodeActivityContext context, LocalWorkflowContext localContext)
        {
            ...
            EntityCollection records = GetConnectedRecords(localContext.OrganizationService, primaryEntityId, connectionRole.Id);
        ...
        {
            Guid record1Id = e.GetAttributeValue<Guid>("record1id");
            Guid id = record1Id == primaryEntityId
                ? e.GetAttributeValue<Guid>("record2id")
                : record1Id;
        ...
        private static int GetTypeCode(Entity e, Guid primaryEntityId)
        {
            ...
            int typeCode = record1Id != primaryEntityId
                ? e.GetAttributeValue<int>("record1objecttypecode")
                : e.GetAttributeValue<int>("record2objecttypecode");
            return typeCode;
        }

        private static EntityCollection GetConnectedRecords(IOrganizationService service, Guid primaryEntityId, Guid connectionRoleId)
        {
            QueryExpression query = new QueryExpression
            {
                EntityName = "connection",
                ColumnSet = new ColumnSet("connectionid", "record1id", "record2id", "record1objecttypecode", "record2objecttypecode"),
